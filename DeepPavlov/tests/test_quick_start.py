...
TEST_MODES = [
    "IP",  # test_inferring_pretrained_model
...
PARAMS = {
    "faq": {
        ("faq/tfidf_logreg_en_faq.json", "faq_tfidf_logreg_en", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("faq/tfidf_autofaq.json", "faq_tfidf_cos", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("faq/tfidf_logreg_autofaq.json", "faq_tfidf_logreg", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("faq/fasttext_avg_autofaq.json", "faq_fasttext_avg", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("faq/fasttext_tfidf_autofaq.json", "faq_fasttext_tfidf", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "spelling_correction": {
    ...
    "go_bot": {
        ("go_bot/gobot_dstc2.json", "gobot_dstc2", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ...
        ("go_bot/gobot_dstc2_minimal.json", "gobot_dstc2_minimal", ("TI",)): [
            ([{"text": "the weather is clooudy and gloooomy"}], None)
        ],
        ("go_bot/gobot_md_yaml_minimal.json", "gobot_md_yaml_minimal", ("TI",)): [
            ([{"text": "start"}], None)
        ],
    },
    "classifiers": {
        ("classifiers/paraphraser_bert.json", "classifiers", ("IP", "TI")): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("classifiers/paraphraser_rubert.json", "classifiers", ("IP", "TI")): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("classifiers/insults_kaggle_bert.json", "classifiers", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/insults_kaggle_conv_bert.json", "classifiers", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/rusentiment_bert.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_dstc2_bert.json", "classifiers", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_dstc2.json", "classifiers", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_dstc2_big.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/insults_kaggle.json", "classifiers", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_twitter.json", "classifiers", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_twitter_bert_emb.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_twitter_preproc.json", "classifiers", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/topic_ag_news.json", "classifiers", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/rusentiment_cnn.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/rusentiment_elmo_twitter_cnn.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/rusentiment_bigru_superconv.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/yahoo_convers_vs_info.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ...
        ("classifiers/sentiment_sst_conv_bert.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_sst_multi_bert.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_yelp_conv_bert.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_yelp_multi_bert.json", "classifiers", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_imdb_bert.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sentiment_imdb_conv_bert.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/sst_torch_swcnn.json", "classifiers", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/insults_kaggle_bert_torch.json", "classifiers", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/glue/glue_mrpc_cased_bert_torch.json", "classifiers", ("TI",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("classifiers/glue/glue_stsb_cased_bert_torch.json", "classifiers", ("TI",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
    },
    "snips": {
        ("classifiers/intents_snips.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_big.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_bigru.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_bilstm.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_bilstm_bilstm.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_bilstm_cnn.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_bilstm_proj_layer.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        (
        ...
        ("classifiers/intents_snips_cnn_bilstm.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_sklearn.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_snips_tfidf_weighted.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "sample": {
        ("classifiers/intents_sample_csv.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("classifiers/intents_sample_json.json", "classifiers", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "entity_linking": {
    ...
    "ner": {
        ...
        ("ner/ner_conll2003_bert.json", "ner_conll2003_bert", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_ontonotes_bert.json", "ner_ontonotes_bert", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_ontonotes_bert_mult.json", "ner_ontonotes_bert_mult", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_rus_bert.json", "ner_rus_bert", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_conll2003.json", "ner_conll2003", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_dstc2.json", "slotfill_dstc2", ALL_MODES): [ONE_ARGUMENT_INFER_CHECK],
        ("ner/ner_ontonotes.json", "ner_ontonotes", ALL_MODES): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_ontonotes_bert_emb.json", "ner_ontonotes_bert_emb", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ner/ner_few_shot_ru_simulate.json", "ner_fs", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ...
        (
            "ner/ner_conll2003_torch_bert.json",
            "ner_conll2003_torch_bert",
            ("IP", "TI"),
        ): [ONE_ARGUMENT_INFER_CHECK],
        ("ner/ner_rus_bert_torch.json", "ner_rus_bert_torch", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "sentence_segmentation": {
        (
            "sentence_segmentation/sentseg_dailydialog.json",
            "sentseg_dailydialog",
            ("IP", "TI"),
    ...
    "elmo_embedder": {
        ("embedder/elmo_ru_news.json", "embedder_ru_news", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "elmo_model": {
        ("elmo/elmo_1b_benchmark_test.json", "elmo_1b_benchmark_test", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "ranking": {
        ("ranking/ranking_insurance.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_insurance_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_mt.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_mt_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_paraphraser.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_paraphraser_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_paraphraser_pretrain.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_paraphraser_tune.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_tune_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_paraphraser_elmo.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_elmo_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_qqp.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_qqp_bilstm_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_qqp_bilstm.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/paraphrase_ident_qqp_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_bert_uncased.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_bert_sep.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_bert_sep_interact.json", "ranking", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v1_mt_word2vec_smn.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v1_mt_word2vec_dam.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        (
        ...
        ("ranking/ranking_ubuntu_v2_mt_word2vec_smn.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("ranking/ranking_ubuntu_v2_mt_word2vec_dam.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        (
            "ranking/ranking_ubuntu_v2_mt_word2vec_dam_transformer.json",
            "ranking",
            ("TI",),
        ): [ONE_ARGUMENT_INFER_CHECK],
        (
        ...
        ("ranking/ranking_ubuntu_v2_torch_bert_uncased.json", "ranking", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "doc_retrieval": {
        ("doc_retrieval/en_ranker_tfidf_wiki_test.json", "doc_retrieval", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("doc_retrieval/ru_ranker_tfidf_wiki_test.json", "doc_retrieval", ("TI",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    ...
    "squad": {
        ("squad/squad_ru_bert.json", "squad_ru_bert", ("IP", "TI")): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_ru_bert_infer.json", "squad_ru_bert_infer", ("IP",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_ru_rubert.json", "squad_ru_rubert", ("IP", "TI")): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_ru_rubert_infer.json", "squad_ru_rubert_infer", ("IP",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_bert.json", "squad_bert", ("IP", "TI")): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_bert_infer.json", "squad_bert_infer", ("IP",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ...
        ("squad/multi_squad_noans.json", "multi_squad_noans", ("IP",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_zh_bert_mult.json", "squad_zh_bert_mult", ALL_MODES): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_zh_bert_zh.json", "squad_zh_bert_zh", ALL_MODES): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_torch_bert.json", "squad_torch_bert", ("IP", "TI")): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
        ("squad/squad_torch_bert_infer.json", "squad_torch_bert_infer", ("IP",)): [
            TWO_ARGUMENTS_INFER_CHECK
        ],
    },
    "odqa": {
        ("odqa/en_odqa_infer_wiki_test.json", "odqa", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("odqa/ru_odqa_infer_wiki_test.json", "odqa", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("odqa/en_odqa_pop_infer_wiki_test.json", "odqa", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
    "morpho_tagger": {
        ("morpho_tagger/UD2.0/morpho_en.json", "morpho_en", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        (
            "morpho_tagger/UD2.0/morpho_ru_syntagrus_pymorphy_lemmatize.json",
            "morpho_tagger_pymorphy",
            ("IP", "TI"),
        ): [ONE_ARGUMENT_INFER_CHECK],
        (
            "morpho_tagger/BERT/morpho_ru_syntagrus_bert.json",
            "morpho_tagger_bert",
            ("IP", "TI"),
        ): [ONE_ARGUMENT_INFER_CHECK],
    },
    "syntax_tagger": {
        ("syntax/syntax_ru_syntagrus_bert.json", "syntax_ru_bert", ("IP", "TI")): [
            ONE_ARGUMENT_INFER_CHECK
        ],
        ("syntax/ru_syntagrus_joint_parsing.json", "syntax_ru_bert", ("IP",)): [
            ONE_ARGUMENT_INFER_CHECK
        ],
    },
...
MARKS = {
    "gpu_only": ["squad"],
    "slow": ["error_model", "go_bot", "squad"],
}  # marks defined in pytest.ini
...
def install_config(config_path):
    ...
    p = pexpect.popen_spawn.PopenSpawn(
        sys.executable + " -m deeppavlov install " + str(config_path),
        timeout=None,
        logfile=logfile,
    )
    p.readlines()
    if p.wait() != 0:
        raise RuntimeError(
            "Installing process of {} returned non-zero exit code: \n{}".format(
                config_path, logfile.getvalue().decode()
            )
        )
...
class TestQuickStart(object):
    ...
    def infer_api(config_path):
        ...
        url_base = "http://{}:{}".format(
            server_params["host"], api_port or server_params["port"]
        )
        url = urljoin(
        ...
        if api_port:
            args += ["-p", str(api_port)]
        p = pexpect.popen_spawn.PopenSpawn(
            " ".join(args), timeout=None, logfile=logfile
        )
        try:
            p.expect(url_base)

            get_url = urljoin(
                url_base.replace("http://0.0.0.0:", "http://127.0.0.1:"), "/api"
            )
            get_response = requests.get(get_url)
            response_code = get_response.status_code
            assert (
                response_code == 200
            ), f"GET /api request returned error code {response_code} with {config_path}"
            ...
            assert (
                response_code == 200
            ), f"POST request returned error code {response_code} with {config_path}"
    ...
    def infer_socket(config_path, socket_type):
        ...
        try:
            ...
            assert resp["status"] == "OK", (
                f"{socket_type} socket request returned status: {resp['status']}"
    ...
    def test_consecutive_training_and_inferring(
        self, model, conf_file, model_dir, mode
    ):
        if "TI" in mode:
            ...
            if p.wait() != 0:
                raise RuntimeError(
                    "Training process of {} returned non-zero exit code: \n{}".format(
                        model_dir, logfile.getvalue().decode()
                    )
                )
            self.infer(
                c, PARAMS[model][(conf_file, model_dir, mode)], check_outputs=False
            )
...
def test_crossvalidation():
    ...
    logfile = io.BytesIO(b"")
    p = pexpect.popen_spawn.PopenSpawn(
        sys.executable + f" -m deeppavlov crossval {c} --folds 2",
        timeout=None,
        logfile=logfile,
    )
    p.readlines()
...
def test_hashes_existence():
    ...
    for config in all_configs:
        ...
        downloads_urls |= {
            d if isinstance(d, str) else d["url"]
            for d in config.get("metadata", {}).get("download", [])
        }
    downloads_urls = [
        url + ".md5" for url in downloads_urls if url.startswith(url_root)
    ]
    messages = []
