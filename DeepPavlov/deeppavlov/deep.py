...
parser.add_argument(
    "mode",
    help="select a mode, train or interact",
    type=str,
    choices={
        "train",
        "evaluate",
...
parser.add_argument(
    "-d", "--download", action="store_true", help="download model components"
)
...
parser.add_argument(
    "-i", "--ms-id", default=None, help="microsoft bot framework app id", type=str
)
parser.add_argument(
    "-s",
    "--ms-secret",
    default=None,
    help="microsoft bot framework app secret",
    type=str,
)

parser.add_argument(
    "--https", action="store_true", default=None, help="run model in https mode"
)
...
parser.add_argument(
    ...
    "--service-name",
    default=None,
    help="service name for agent-rabbit mode",
    type=str,
)
parser.add_argument(
    "-an", "--agent-namespace", default=None, help="dp-agent namespace name", type=str
)
parser.add_argument(
    "-ul",
    "--utterance-lifetime",
    default=None,
    help="message expiration in seconds",
    type=int,
)
parser.add_argument(
    "-rh", "--rabbit-host", default=None, help="RabbitMQ server host", type=str
)
parser.add_argument(
    "-rp", "--rabbit-port", default=None, help="RabbitMQ server port", type=int
)
parser.add_argument(
    "-rl", "--rabbit-login", default=None, help="RabbitMQ server login", type=str
)
parser.add_argument(
    "-rpwd",
    "--rabbit-password",
...
parser.add_argument(
    ...
    "--rabbit-virtualhost",
    default=None,
    help="RabbitMQ server virtualhost",
    type=str,
)
...
def main():
    ...
    if args.mode == "train":
        ...
        train_evaluate_model_from_config(
            pipeline_config_path, to_train=False, start_epoch_num=args.start_epoch_num
        )
        ...
        start_model_server(
            pipeline_config_path, args.https, args.key, args.cert, port=args.port
        )
