...
from deeppavlov.utils.alexa.request_parameters import (
    data_body,
    cert_chain_url_header,
    signature_header,
)
from deeppavlov.utils.connector import AlexaBot
from deeppavlov.utils.server import (
    get_ssl_params,
...
def start_alexa_server(
    ...
    async def interact(
        ...
        signature_chain_url: str = cert_chain_url_header,
    ) -> JSONResponse:
