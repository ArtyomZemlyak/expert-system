...
# TODO: make better
def train_model(
    config: [str, Path, dict], download: bool = False, recursive: bool = False
) -> Chainer:
...
def evaluate_model(
    ...
    return train_evaluate_model_from_config(
        config, to_train=False, download=download, recursive=recursive
    )
