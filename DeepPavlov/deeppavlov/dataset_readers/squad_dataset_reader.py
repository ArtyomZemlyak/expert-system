...
class MultiSquadDatasetReader(DatasetReader):
    ...
    url_multi_squad_retr = (
        "http://files.deeppavlov.ai/datasets/multi_squad_retr_enwiki20161221.tar.gz"
    )
    url_multi_squad_ru_retr = (
        "http://files.deeppavlov.ai/datasets/multi_squad_ru_retr.tar.gz"
    )
