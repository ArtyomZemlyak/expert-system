...
class ParaphraserReader(DatasetReader):
    ...
    def read(
        self, data_path: str, do_lower_case: bool = True, *args, **kwargs
    ...
    def _build_data(
        ...
        for paraphrase in root.findall("corpus/paraphrase"):
            ...
            data[key] = (
                1 if int(paraphrase.find('value[@name="class"]').text) >= 0 else 0
            )
