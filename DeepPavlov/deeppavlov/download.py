...
parser.add_argument(
    "--config", "-c", help="path to a pipeline json config", type=str, default=None
)
parser.add_argument(
    "-all",
    action="store_true",
...
def download_resource(
    url: str, dest_paths: Iterable[Union[Path, str]], headers: Optional[dict] = None
) -> None:
